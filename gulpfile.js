...
gulp.task('server', function(){
  var server = express()
    .use(express.static(path.resolve(Config.paths.build.root)))
    .listen(Config.port);
...
gulp.task('build', ['styles', 'fonts', 'extra', 'html', 'images']);
gulp.task('default', ['server', 'livereload', 'styles', 'fonts', 'extra', 'html', 'images', 'watch'], function(){
